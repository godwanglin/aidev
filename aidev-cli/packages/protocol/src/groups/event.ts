...
import { EventManifest } from "@aidev-cli/schema/event-manifest"
import { Location } from "@aidev-cli/schema/location"
import type { Definition } from "@aidev-cli/schema/event"
...
export const AidevCLIEvent = event.schema
export type AidevCLIEvent = typeof AidevCLIEvent.Type
export type AidevCLIEventEncoded = typeof AidevCLIEvent.Encoded
