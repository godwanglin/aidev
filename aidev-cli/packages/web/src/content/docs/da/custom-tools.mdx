...
description: Opret værktøjer, som LLM kan kalde aidev-cli ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med aidev-clis [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.aidev-cli/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/aidev-cli/tools/`.
