---
title: TUI
description: Brug af AidevCLI-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AidevCLI giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre AidevCLI starter TUI for den nuværende mappe.
...
Når du bruger AidevCLI TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til AidevCLI. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut AidevCLI. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `aidev-cli.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe AidevCLI venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `aidev-cli.default`.
