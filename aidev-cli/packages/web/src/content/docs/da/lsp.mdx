---
title: LSP-servere
description: AidevCLI integreres med dine LSP-servere.
---

AidevCLI kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

AidevCLI leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `AIDEV_CLI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og aidev-cli åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din aidev-cli-konfiguration.
