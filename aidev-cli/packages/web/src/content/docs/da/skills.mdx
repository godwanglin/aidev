...
Agentferdigheter lar AidevCLI oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
AidevCLI søker etter disse stedene:
...
For prosjektlokale stier går AidevCLI opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
AidevCLI viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `aidev-cli.json`:
