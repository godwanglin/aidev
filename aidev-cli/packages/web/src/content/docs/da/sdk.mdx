...
Brug den til at bygge integrasjoner og kontrollere aidev-cli programmatisk.
...
Opret en forekomst av aidev-cli:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `aidev-cli.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av aidev-cli, kan du oprete en klientforekomst for at koble til den:
