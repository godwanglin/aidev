...
AidevCLI Go est un abonnement à bas coût à **10 $/mois** qui vous donne un accès fiable aux modèles de codage ouverts populaires.

Go fonctionne comme n'importe quel autre fournisseur dans AidevCLI. Vous vous abonnez à AidevCLI Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser AidevCLI.
...
AidevCLI Go vous donne accès à ces modèles pour **10 $/mois**.

---

## Comment ça marche

AidevCLI Go fonctionne comme n'importe quel autre fournisseur dans AidevCLI.

1. Vous vous connectez à **<a href={console}>AidevCLI Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
2. Vous exécutez la commande `/connect` dans la TUI, sélectionnez `AidevCLI Go` et collez votre clé d'API.
3. Exécutez `/models` dans la TUI pour voir la liste des modèles disponibles via Go.

:::note
Un seul membre par espace de travail peut s'abonner à AidevCLI Go.
:::
...
AidevCLI Go est conçu pour être utilisé avec [AidevCLI](https://aidev-cli.ai) et d'autres agents de codage populaires qui génèrent des types de requêtes similaires.

Le trafic est surveillé afin de détecter tout trafic abusif qui dégrade l'expérience des autres utilisateurs.

Pour éviter que votre compte ne soit signalé, assurez-vous que l'outil que vous utilisez

1\. ne génère pas de trafic abusif  
2\. s'identifie correctement (pas d'agents utilisateur génériques)  
3\. inclut l'en-tête `x-aidev-cli-session` afin que nous puissions optimiser la mise en cache des prompts

## Limites d'utilisation

AidevCLI Go inclut les limites suivantes :
...
| ---------------------------- | ---------------------------- | ------------------------------------------------ | --------------------------- |
| Grok 4.6                     | grok-4.6                     | `https://aidev-cli.ai/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| GPT 5.6 Luna                 | gpt-5.6-luna                 | `https://aidev-cli.ai/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| GLM-5.3-Flash                | glm-5.3-flash                | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.3                      | glm-5.3                      | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.2                      | glm-5.2                      | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.1                      | glm-5.1                      | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K3                      | kimi-k3                      | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.7 Code               | kimi-k2.7-code               | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6                    | kimi-k2.6                    | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| LongCat-2.0                  | longcat-2.0                  | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro              | deepseek-v4-pro              | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash            | deepseek-v4-flash            | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Vision Exp | deepseek-v4-flash-vision-exp | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5                    | mimo-v2.5                    | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro                | mimo-v2.5-pro                | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M3                   | minimax-m3                   | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.7                 | minimax-m2.7                 | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5                 | minimax-m2.5                 | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Muse Spark 1.3 Contributor   | muse-spark-1.3-contributor   | `https://aidev-cli.ai/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| Muse Spark 1.2 Contributor   | muse-spark-1.2-contributor   | `https://aidev-cli.ai/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| Qwen3.8 Max                  | qwen3.8-max                  | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.8 Flash                | qwen3.8-flash                | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Max                  | qwen3.7-max                  | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus                 | qwen3.7-plus                 | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus                 | qwen3.6-plus                 | `https://aidev-cli.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Hy4 preview                  | hy4-preview                  | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Hy3                          | hy3                          | `https://aidev-cli.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |

L'[ID de modèle](/docs/config/#models) dans votre configuration AidevCLI utilise le format `aidev-cli-go/<model-id>`. Par exemple, pour Kimi K3, vous utiliseriez `aidev-cli-go/kimi-k3` dans votre configuration.
...
```
https://aidev-cli.ai/zen/go/v1/models
```
...
Nous avons créé AidevCLI Go pour :
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec AidevCLI également.
