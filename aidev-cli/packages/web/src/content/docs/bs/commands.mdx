...
Kreiraj `.aidev-cli/commands/test.md`:
...
Možete dodati prilagođene komande kroz AidevCLI konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom AidevCLI [config](/docs/config):
...
- Globalno: `~/.config/aidev-cli/commands/`
- Po projektu: `.aidev-cli/commands/`
...
AidevCLI uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
