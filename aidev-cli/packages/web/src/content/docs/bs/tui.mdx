---
title: TUI
description: Korištenje korisničkog interfejsa AidevCLI terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AidevCLI pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje AidevCLI pokreće TUI za trenutni direktorij.
...
Kada koristite AidevCLI TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u AidevCLI. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz AidevCLI. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `aidev-cli.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo AidevCLI čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `aidev-cli.default`.
