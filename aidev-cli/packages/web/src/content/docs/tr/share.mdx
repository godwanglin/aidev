---
title: Paylasim
description: aidev-cli konusmalarini genel baglantilarla paylasin.
---

aidev-cli'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda aidev-cli:
...
aidev-cli, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak aidev-cli manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `aidev-cli.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda aidev-cli kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
