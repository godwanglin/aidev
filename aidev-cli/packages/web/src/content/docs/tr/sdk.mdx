---
title: SDK
description: aidev-cli sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

aidev-cli JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
aidev-cli'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir aidev-cli örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `aidev-cli.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir aidev-cli örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
