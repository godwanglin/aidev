---
title: TUI
description: Bruke aidev-cli-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AidevCLI gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre AidevCLI starter TUI for gjeldende katalog.
...
Når du bruker AidevCLI TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til AidevCLI. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt AidevCLI. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `aidev-cli.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge AidevCLI venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `aidev-cli.default`.
