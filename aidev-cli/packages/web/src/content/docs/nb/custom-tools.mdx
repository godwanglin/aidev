...
description: Lag verktøy som LLM kan kalle inn AidevCLI.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med AidevCLI sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.aidev-cli/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/aidev-cli/tools/`.
