---
title: LSP-servere
description: aidev-cli integreres med LSP-serverne dine.
---

AidevCLI kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

AidevCLI kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `AIDEV_CLI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og aidev-cli åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i AidevCLI-konfigurasjonen.
