...
Opprett `.aidev-cli/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom AidevCLI-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i AidevCLI [config](/docs/config):
...
- Per prosjekt: `.aidev-cli/commands/`
...
AidevCLI inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
