---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące aidev-cli.
---

Funkcja udostępniania aidev-cli umożliwia tworzenie publicznych linków do konwersacji aidev-cli, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, aidev-cli:
...
aidev-cli obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie aidev-cli korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `aidev-cli.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu aidev-cli w Twojej organizacji.
