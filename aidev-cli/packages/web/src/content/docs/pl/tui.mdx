---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala aidev-cli.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

aidev-cli zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie aidev-cli uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI aidev-cli, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do aidev-cli. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij aidev-cli. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `aidev-cli.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo AidevCLI czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `aidev-cli.default`.
