---
title: Teilen
description: Teile AidevCLI-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu AidevCLI-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht AidevCLI Folgendes:
...
AidevCLI hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt AidevCLI den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`aidev-cli.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du aidev-cli in deiner Organisation einsetzt.
