...
Crear `.aidev-cli/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración AidevCLI o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su AidevCLI [config](/docs/config):
...
- Por proyecto: `.aidev-cli/commands/`
...
aidev-cli incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
