...
description: Crea strumenti che l'LLM puo chiamare in aidev-cli.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di aidev-cli come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.aidev-cli/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/aidev-cli/tools/`.
