...
สร้าง `.aidev-cli/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ AidevCLI:
...
- ระดับผู้ใช้ (Global): `~/.config/aidev-cli/commands/`
- ระดับโปรเจ็กต์: `.aidev-cli/commands/`
...
AidevCLI มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
