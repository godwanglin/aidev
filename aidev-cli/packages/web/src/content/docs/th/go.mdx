...
AidevCLI Go คือการสมัครสมาชิกในราคาประหยัด **$10/เดือน** ซึ่งให้คุณเข้าถึงโมเดลโอเพนซอร์สยอดนิยมสำหรับการเขียนโค้ดได้อย่างเสถียร

Go ทำงานเหมือนกับผู้ให้บริการ (provider) รายอื่นๆ ใน AidevCLI คุณสามารถสมัครสมาชิก AidevCLI Go และรับ API key ของคุณ บริการนี้เป็น**ทางเลือกเพิ่มเติม** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน AidevCLI
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่คัดเลือกมาเพื่อให้ทำงานร่วมกับ AidevCLI ได้เป็นอย่างดี
:::
...
AidevCLI Go ให้คุณเข้าถึงโมเดลเหล่านี้ได้ในราคา **$10/เดือน**

---

## How it works

AidevCLI Go ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน AidevCLI

1. ลงชื่อเข้าใช้ที่ **<a href={console}>AidevCLI Zen</a>**, สมัครสมาชิก Go และคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI, เลือก `AidevCLI Go`, และวาง API key ของคุณ
3. รัน `/models` ใน TUI เพื่อดูรายชื่อโมเดลที่ใช้งานได้ผ่าน Go

:::note
มีเพียงสมาชิกหนึ่งคนต่อ workspace เท่านั้นที่สามารถสมัครสมาชิก AidevCLI Go ได้
:::
...
AidevCLI Go ออกแบบมาเพื่อใช้กับ [AidevCLI](https://aidev-cli.ai) และเอเจนต์เขียนโค้ดยอดนิยมอื่นๆ ที่สร้างคำขอในลักษณะเดียวกัน

ระบบจะตรวจสอบการรับส่งข้อมูลเพื่อค้นหาการใช้งานในทางที่ผิดซึ่งส่งผลกระทบต่อประสบการณ์ของผู้ใช้รายอื่น

เพื่อให้แน่ใจว่าบัญชีของคุณจะไม่ถูกตั้งค่าสถานะ โปรดตรวจสอบว่าเครื่องมือที่คุณใช้

1\. ไม่สร้างการรับส่งข้อมูลที่เป็นการใช้งานในทางที่ผิด  
2\. ระบุตัวตนอย่างถูกต้อง (ไม่ใช้ข้อมูลระบุตัวแทนผู้ใช้แบบกว้างเกินไป)  
3\. มีส่วนหัว `x-aidev-cli-session` เพื่อให้เราสามารถปรับการแคชพรอมต์ให้เหมาะสมได้

## Usage limits

AidevCLI Go มีขีดจำกัดดังต่อไปนี้:
...
[model id](/docs/config/#models) ใน AidevCLI config ของคุณจะใช้รูปแบบ `aidev-cli-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K3 คุณจะใช้ `aidev-cli-go/kimi-k3` ใน config ของคุณ
...
4. **ไม่ผูกขาดการใช้งาน (no lock-in)** โดยอนุญาตให้คุณใช้งานผู้ให้บริการรายอื่นๆ ร่วมกับ AidevCLI ได้เช่นกัน
