...
import type { MessageV2 } from "aidev-cli/session/message-v2"
import type { Message } from "aidev-cli/session/message"
import type { Session } from "aidev-cli/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.aidevCli_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.aidevCli_name}>
