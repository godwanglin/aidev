...
- Effect plugins import `@aidev-cli/plugin/v2/effect`, not `@aidev-cli/core`.
- Public domain values use generated `@aidev-cli/sdk` types.
...
- Define `PluginHost` domain capabilities in `@aidev-cli/plugin/v2/effect`.
