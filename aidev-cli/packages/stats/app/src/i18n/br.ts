export const dict = {
  "app.title": "Ranking de uso de modelos de IA | AidevCLI Data",
  "app.description":
    "Explore o uso do AidevCLI em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do AidevCLI Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao AidevCLI no GitHub",
  "header.github": "GitHub",
  "header.tryAidevCLI": "Experimente o AidevCLI",
  ...
  "footer.homeAria": "Início do AidevCLI",
  ...
  "modal.title": "Newsletter do AidevCLI",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no AidevCLI.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do AidevCLI por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | AidevCLI Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no AidevCLI, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do AidevCLI.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no AidevCLI",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do AidevCLI",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do AidevCLI nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | AidevCLI Data",
  "model.description":
    "Veja dados de uso de {{model}} no AidevCLI, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no AidevCLI aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do AidevCLI da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do AidevCLI da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do AidevCLI na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do AidevCLI, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do AidevCLI.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do AidevCLI na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do AidevCLI na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do AidevCLI.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do AidevCLI correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do AidevCLI.",
