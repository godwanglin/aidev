export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | AidevCLI Data",
  "app.description":
    "AidevCLI kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde AidevCLI Data logosu",
  ...
  "header.githubAria": "GitHub'da AidevCLI'a yıldız ver",
  "header.github": "GitHub",
  "header.tryAidevCLI": "AidevCLI'u dene",
  ...
  "footer.homeAria": "AidevCLI ana sayfası",
  ...
  "home.topModelsDescription": "AidevCLI genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz AidevCLI kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | AidevCLI Data",
  "lab.description":
    "AidevCLI'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son AidevCLI kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "AidevCLI'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son AidevCLI kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük AidevCLI token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | AidevCLI Data",
  "model.description":
    "{{model}} için AidevCLI kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda AidevCLI kullanımı görünür.",
  "model.unranked": "Geçen haftaki AidevCLI kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki AidevCLI kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde AidevCLI kullanımı yok.",
  ...
  "model.overviewDescription": "Son AidevCLI tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz AidevCLI kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük AidevCLI token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz AidevCLI kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama AidevCLI oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen AidevCLI coğrafi satırı yok.",
  "model.peersDescription": "Son AidevCLI token hacmine göre yakındaki modeller.",
