export const dict = {
  "app.title": "Rankingi użycia modeli AI | AidevCLI Data",
  "app.description":
    "Przeglądaj użycie AidevCLI w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny AidevCLI Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę AidevCLI na GitHub",
  "header.github": "GitHub",
  "header.tryAidevCLI": "Wypróbuj AidevCLI",
  ...
  "footer.homeAria": "Strona główna AidevCLI",
  ...
  "home.topModelsDescription": "Użycie modeli w AidevCLI.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy AidevCLI według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | AidevCLI Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w AidevCLI, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia AidevCLI.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w AidevCLI",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia AidevCLI",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów AidevCLI z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | AidevCLI Data",
  "model.description":
    "Zobacz dane użycia {{model}} w AidevCLI, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie AidevCLI pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu AidevCLI z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu AidevCLI z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia AidevCLI w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny AidevCLI, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia AidevCLI.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów AidevCLI w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy AidevCLI w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji AidevCLI.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne AidevCLI nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów AidevCLI.",
