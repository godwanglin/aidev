export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | AidevCLI Data",
  "app.description":
    "Esplora l'utilizzo di AidevCLI nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo AidevCLI Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a AidevCLI su GitHub",
  "header.github": "GitHub",
  "header.tryAidevCLI": "Prova AidevCLI",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in AidevCLI.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di AidevCLI per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | AidevCLI Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in AidevCLI, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di AidevCLI.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in AidevCLI",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di AidevCLI",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token AidevCLI negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | AidevCLI Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in AidevCLI, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di AidevCLI appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo AidevCLI della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo AidevCLI della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di AidevCLI nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di AidevCLI, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di AidevCLI.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token AidevCLI nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di AidevCLI nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione AidevCLI.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica AidevCLI corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token AidevCLI.",
