import aidevCliWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/aidev-cli",
  fallbackStars: "195K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = ""aidev-cli":stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://aidev_cli.ai/">
            <strong>{i18n.t("header.tryAidevCLI")}</strong>
          </a>
          <button
...
function AidevCLIMark() {
  return (
    <svg data-slot="aidev-cli-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://aidev_cli.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://aidev_cli.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@aidev_cli.ai", label: i18n.t("footer.contact") },
    { href: "https://aidev_cli.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/aidev-cli", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://aidev_cli.ai" aria-label={i18n.t("footer.homeAria")}>
          <AidevCLIMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={aidevCliWordmarkDark} alt="AidevCLI" />
          <button
