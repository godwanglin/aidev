...
import {
  ...
  type StatsModelData,
} from "@aidev-cli/stats-core/domain/home"
import { statModel } from "@aidev-cli/stats-core/domain/model-normalization"
...
export default function StatsModel() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="AidevCLI" />
      ...
      >
        {(data) => (
          <p data-slot="model-hero-rankline">
            ...
            <span data-slot="model-hero-pill">AidevCLI</span>
