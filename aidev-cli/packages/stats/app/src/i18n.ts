...
const en = {
  "app.title": "AI Model Usage Rankings | AidevCLI Data",
  "app.description":
    "Explore AidevCLI usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "AidevCLI Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star AidevCLI on GitHub",
  "header.github": "GitHub",
  "header.tryAidevCLI": "Try AidevCLI",
  ...
  "home.topModelsDescription": "Usage of models across AidevCLI.",
  ...
  "home.uniqueUsersDescription": "Daily unique AidevCLI users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | AidevCLI Data",
  "lab.description":
    "Compare {{lab}} models used in AidevCLI, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent AidevCLI usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in AidevCLI",
  ...
  "lab.shareOfUsage": "{{share}} of recent AidevCLI usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | AidevCLI Data",
  "model.description":
    "View {{model}} AidevCLI usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. AidevCLI usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's AidevCLI usage",
  "model.ranked": "Ranked #{{rank}} across last week's AidevCLI usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No AidevCLI usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no AidevCLI usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No AidevCLI geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent AidevCLI token volume.",
