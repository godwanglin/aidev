export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de AidevCLI",
  ...
  "desktop.menu.ariaLabel": "Menú de AidevCLI",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar AidevCLI",
  "desktop.recovery.terminated": "La ventana de AidevCLI se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "AidevCLI no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar AidevCLI",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli no está instalado en esta distribución",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de AidevCLI finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.aidev_cli.tagline": "Modelos optimizados y fiables",
  "dialog.provider.aidevCliGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.aidevCliZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en AidevCLI.",
  ...
  "dialog.plugins.empty": "Plugins configurados en aidev_cli.json",
  ...
  "dialog.server.description": "Cambiar el servidor de AidevCLI al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando AidevCLI en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando AidevCLI en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza AidevCLI en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI está listo en {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala AidevCLI en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que AidevCLI pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de AidevCLI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de AidevCLI",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (aidev_cli.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: AidevCLI aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor AidevCLI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para AidevCLI",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve AidevCLI en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si AidevCLI sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de AidevCLI.",
