...
export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.aidev_cli.tagline": "Reliable optimized models",
  "dialog.provider.aidevCliGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AidevCLI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.aidevCliZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.aidevCliZen.visit.prefix": "Visit ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AidevCLI.",
  ...
  "dialog.plugins.empty": "Plugins configured in aidev_cli.json",
  ...
  "dialog.server.description": "Switch which AidevCLI server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AidevCLI in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AidevCLI in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AidevCLI in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI is ready in {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI is ready.",
  "wsl.onboarding.installOpencodeIn": "Install AidevCLI in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before AidevCLI can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of AidevCLI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AidevCLI team",
  ...
  "error.chain.checkConfig": "Check your config (aidev_cli.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AidevCLI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the AidevCLI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AidevCLI",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how AidevCLI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AidevCLI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AidevCLI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AidevCLI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AidevCLI.",
