...
const desktop = [
  ...
  "Kilépés",
  "Az AidevCLI betöltése sikertelen",
  "Az AidevCLI ablaka váratlanul leállt",
  "Az AidevCLI nem válaszol",
  ...
  "Az AidevCLI telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az aidev_cli nincs telepítve ebben a disztribúcióban",
  "Az aidev_cli telepítve van, de nem futtatható",
  "Az AidevCLI nincs telepítve ebben: {{distro}}",
  "Az AidevCLI frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.aidev_cli.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.aidevCliGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A AidevCLI ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a AidevCLI-ben.",
  ...
  "provider.connect.aidevCliZen.line1":
    "A AidevCLI Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Látogatás",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a AidevCLI-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a AidevCLI-ben.",
  ...
  "dialog.plugins.empty": "Az aidev_cli.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik AidevCLI szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "AidevCLI ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "AidevCLI frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "AidevCLI frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a AidevCLI-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a AidevCLI-t",
  "wsl.onboarding.aidevCliReadyIn": "A AidevCLI készen áll a {{distro}}-ben.",
  "wsl.onboarding.aidevCliReady": "A AidevCLI készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a AidevCLI-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a AidevCLI-t",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "A AidevCLI nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a AidevCLI hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A AidevCLI nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a AidevCLI programot.",
  ...
  "help.tabs.introduction": "A AidevCLI Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A AidevCLI ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a AidevCLI csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (aidev_cli.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a AidevCLI még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A AidevCLI ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "AidevCLI asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a AidevCLI szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a AidevCLI kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a AidevCLI az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a AidevCLI a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a AidevCLI témáját.",
  ...
  "settings.updates.row.startup.description": "A AidevCLI indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a AidevCLI legújabb verzióját futtatja.",
