export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI hujjatlari",
  ...
  "desktop.menu.ariaLabel": "AidevCLI menyusi",
  ...
  "desktop.recovery.loadFailed": "AidevCLI yuklanmadi",
  "desktop.recovery.terminated": "AidevCLI oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "AidevCLI javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.aidevCliMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "AidevCLI yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.aidev_cli.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.aidevCliGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLI tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va AidevCLI’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va AidevCLI da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va AidevCLI da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "aidev_cli.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi AidevCLI serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "AidevCLI {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "AidevCLI yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "AidevCLI {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "AidevCLI-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "AidevCLI-ni yangilang",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI {{distro}} da tayyor.",
  "wsl.onboarding.aidevCliReady": "AidevCLI tayyor.",
  "wsl.onboarding.installOpencodeIn": "AidevCLI-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "AidevCLI-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AidevCLI WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra AidevCLI-ni qayta oching.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AidevCLI ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida AidevCLI jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (aidev_cli.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, AidevCLI hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "AidevCLI bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi AidevCLI serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "AidevCLI uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "AidevCLI qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "AidevCLI tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "AidevCLI mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "AidevCLI ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz AidevCLI oxirgi versiyasini ishga tushiryapsiz.",
