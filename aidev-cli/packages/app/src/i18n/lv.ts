export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI dokumentācija",
  ...
  "desktop.menu.ariaLabel": "AidevCLI izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt AidevCLI",
  "desktop.recovery.terminated": "AidevCLI logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "AidevCLI neatbild",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli nav instalēts šajā distribūcijā",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.aidev_cli.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.aidevCliGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Apmeklējiet",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus AidevCLI.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti aidev_cli.json",
  ...
  "dialog.server.description": "Mainiet, pie kura AidevCLI servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu AidevCLI distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu AidevCLI distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet AidevCLI distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet AidevCLI distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms AidevCLI var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet AidevCLI no jauna.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna AidevCLI versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu AidevCLI komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (aidev_cli.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, AidevCLI vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "AidevCLI darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist AidevCLI serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt AidevCLI saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā AidevCLI izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai AidevCLI sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet AidevCLI tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko AidevCLI versiju.",
