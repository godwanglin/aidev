export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "AidevCLI لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "AidevCLI دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "AidevCLI جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.aidevCliMissing": "اس ڈسٹرو وچ aidev_cli انسٹال نئیں اے",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.aidevCliNotInstalled": "{{distro}} وچ AidevCLI انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "AidevCLI دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.aidev_cli.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.aidev_cli.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.aidevCliGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLI دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے AidevCLI وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "ویکھو ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے AidevCLI وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے AidevCLI وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "aidev_cli.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس AidevCLI سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ AidevCLI دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "AidevCLI نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ AidevCLI نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ AidevCLI نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "AidevCLI اپ ڈیٹ کرو",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI {{distro}} چ تیار اے۔",
  "wsl.onboarding.aidevCliReady": "AidevCLI تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ AidevCLI انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "AidevCLI انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AidevCLI دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر AidevCLI دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "AidevCLI Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AidevCLI ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع AidevCLI ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (aidev_cli.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، AidevCLI ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر AidevCLI سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "AidevCLI لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے AidevCLI کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا AidevCLI سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "AidevCLI نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں AidevCLI لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی AidevCLI دا تازہ ترین ورژن چلا رئے او۔",
