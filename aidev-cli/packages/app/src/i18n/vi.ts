export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu AidevCLI",
  ...
  "desktop.recovery.loadFailed": "Không tải được AidevCLI",
  "desktop.recovery.terminated": "Cửa sổ AidevCLI đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "AidevCLI không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được AidevCLI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật AidevCLI nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.aidev_cli.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.aidevCliGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do AidevCLI cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Truy cập ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong AidevCLI.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong aidev_cli.json",
  ...
  "dialog.server.description": "Chuyển máy chủ AidevCLI mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra AidevCLI trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật AidevCLI trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật AidevCLI trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt AidevCLI trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi AidevCLI có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của AidevCLI ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm AidevCLI",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (aidev_cli.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: AidevCLI chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ AidevCLI bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho AidevCLI",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của AidevCLI trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem AidevCLI tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi AidevCLI khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của AidevCLI.",
