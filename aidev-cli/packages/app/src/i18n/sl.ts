export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "AidevCLI ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno AidevCLI se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "AidevCLI se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev AidevCLI ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli ni nameščen v tej distribuciji",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev AidevCLI je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.aidev_cli.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.aidevCliGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Obisk ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v AidevCLI.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v aidev_cli.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom AidevCLI se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje AidevCLI ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje AidevCLI v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje AidevCLI ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje AidevCLI v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite AidevCLI v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI je pripravljen v {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite AidevCLI v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko AidevCLI doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica AidevCLI ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi AidevCLI",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (aidev_cli.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, AidevCLI še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik AidevCLI znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za AidevCLI",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako AidevCLI izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali AidevCLI sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico AidevCLI.",
