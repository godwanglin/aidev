export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja AidevCLI",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać AidevCLI",
  "desktop.recovery.terminated": "Okno AidevCLI zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "AidevCLI nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować AidevCLI",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.aidevCliMissing": "Program aidev_cli nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.aidevCliCannotRun": "Program aidev_cli jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja AidevCLI została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.aidev_cli.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.aidevCliGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Odwiedź ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AidevCLI.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku aidev_cli.json",
  ...
  "dialog.server.description": "Przełącz serwer AidevCLI, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie AidevCLI w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie AidevCLI w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj AidevCLI w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj AidevCLI w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim AidevCLI będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja AidevCLI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AidevCLI",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (aidev_cli.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: AidevCLI nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "AidevCLI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer AidevCLI wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AidevCLI",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd AidevCLI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AidevCLI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AidevCLI.",
