export const dict = {
  ...
  "desktop.recovery.loadFailed": "AidevCLI መጫን አልቻለም",
  "desktop.recovery.terminated": "AidevCLI መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "AidevCLI ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLIመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.aidevCliMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.aidevCliCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "AidevCLI ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.aidev_cli.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.aidevCliGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በAidevCLI",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በAidevCLI ይጠቀሙ።",
  ...
  "provider.connect.aidevCliZen.line1": "AidevCLI ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.aidevCliZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.aidevCliZen.visit.prefix": "ጎብኝ ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በAidevCLI ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በAidevCLI ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ aidev_cli.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው AidevCLI አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "AidevCLIን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ AidevCLI በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን AidevCLI በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.aidevCliReady": "AidevCLI ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን AidevCLI በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLIአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) AidevCLI WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ AidevCLI።",
  ...
  "help.tabs.introduction": "AidevCLI ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የAidevCLI ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለAidevCLI ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (aidev_cli.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ AidevCLI እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "AidevCLI ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የAidevCLI አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለAidevCLI",
  ...
  "settings.general.row.appearance.description": "AidevCLIበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "AidevCLI ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "AidevCLI ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "AidevCLI ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የAidevCLI እትም እያሄዱ ነው።",
