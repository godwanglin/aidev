export const dict = {
  ...
  "desktop.recovery.loadFailed": "AidevCLIを読み込めませんでした",
  "desktop.recovery.terminated": "AidevCLIのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "AidevCLIが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLIのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.aidevCliMissing": "このディストリビューションにはaidev-cliがインストールされていません",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cliはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.aidevCliNotInstalled": "{{distro}}にはAidevCLIがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "AidevCLIのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.aidev_cli.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.aidev_cli.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.aidevCliGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLIが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、AidevCLIで{{provider}}モデルを使用します。",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.aidevCliZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.aidevCliZen.visit.prefix": " ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAidevCLIで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、AidevCLIで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "aidev_cli.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するAidevCLIサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLIを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のAidevCLIを確認中...",
  "wsl.onboarding.updatingOpencode": "AidevCLIを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のAidevCLIを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のAidevCLIを更新してください。",
  "wsl.onboarding.updateOpencode": "AidevCLIを更新",
  "wsl.onboarding.aidevCliReadyIn": "{{distro}}内のAidevCLIの準備ができました。",
  "wsl.onboarding.aidevCliReady": "AidevCLIの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にAidevCLIをインストールしてください。",
  "wsl.onboarding.installOpencode": "AidevCLIをインストール",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLIがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AidevCLIでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、AidevCLIをもう一度開いてください。",
  ...
  "help.tabs.introduction": "AidevCLI Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AidevCLIの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAidevCLIチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (aidev_cli.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: AidevCLIはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "AidevCLIには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAidevCLIサーバーを実行します。",
  ...
  "settings.general.row.language.description": "AidevCLIの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのAidevCLIの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "AidevCLIがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "AidevCLIのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "AidevCLI の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "AidevCLI は最新バージョンです。",
