export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.aidev_cli.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.aidevCliGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLIn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AidevCLIssa.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Avaa ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja AidevCLIssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AidevCLIssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään aidev_cli.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda AidevCLI-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan AidevCLIa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan AidevCLIa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään AidevCLIa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään AidevCLIa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä AidevCLI jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI on valmis jakelussa {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna AidevCLI jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLIa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin AidevCLI voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten AidevCLI uudelleen.",
  ...
  "toast.update.description": "AidevCLIn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä AidevCLI-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (aidev_cli.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että AidevCLI ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita AidevCLI-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda AidevCLIn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä AidevCLI näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö AidevCLI järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta AidevCLIn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun AidevCLI käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät AidevCLIn uusinta versiota.",
  ...
  "desktop.menu.documentation": "AidevCLI-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "AidevCLI-valikko",
  ...
  "desktop.recovery.loadFailed": "AidevCLIn lataaminen epäonnistui",
  "desktop.recovery.terminated": "AidevCLI-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "AidevCLI ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLIn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.aidevCliMissing": "aidevClia ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLIa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLIn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "AidevCLI Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
