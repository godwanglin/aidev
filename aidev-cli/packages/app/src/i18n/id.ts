export const dict = {
  ...
  "desktop.recovery.loadFailed": "AidevCLI gagal dimuat",
  "desktop.recovery.terminated": "Jendela AidevCLI berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "AidevCLI tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi AidevCLI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli belum terinstal di distro ini",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan AidevCLI selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.aidev_cli.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.aidevCliGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di AidevCLI.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di aidev_cli.json",
  ...
  "dialog.server.description": "Ganti server AidevCLI mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa AidevCLI di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui AidevCLI di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui AidevCLI di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI siap di {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI siap.",
  "wsl.onboarding.installOpencodeIn": "Instal AidevCLI di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum AidevCLI dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru AidevCLI ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim AidevCLI",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (aidev_cli.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: AidevCLI belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server AidevCLI di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk AidevCLI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan AidevCLI di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah AidevCLI mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat AidevCLI diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru AidevCLI.",
