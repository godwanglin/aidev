export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI Documentació",
  ...
  "desktop.menu.ariaLabel": "menú AidevCLI.",
  ...
  "desktop.recovery.loadFailed": "AidevCLI no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra AidevCLI s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "AidevCLI no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de AidevCLI ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli no està instal·lat en aquesta distribució",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.aidev_cli.tagline": "Models optimitzats fiables",
  "dialog.provider.aidevCliGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.aidevCliZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a AidevCLI.",
  ...
  "dialog.plugins.empty": "Connectors configurats a aidev_cli.json",
  ...
  "dialog.server.description": "Canvia a quin AidevCLI servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant AidevCLI a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant AidevCLI a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza AidevCLI a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI està llest a {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu AidevCLI a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que AidevCLI pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de AidevCLI ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip AidevCLI.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (aidev_cli.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que AidevCLI encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "AidevCLI Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor AidevCLI dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a AidevCLI",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu AidevCLI al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si AidevCLI segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de AidevCLI.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï AidevCLI.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de AidevCLI.",
