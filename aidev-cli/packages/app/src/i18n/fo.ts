export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI Skjøl",
  ...
  "desktop.menu.ariaLabel": "AidevCLI valmynd",
  ...
  "desktop.recovery.loadFailed": "AidevCLI miseydnaðist at heinta",
  "desktop.recovery.terminated": "AidevCLI vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "AidevCLI svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli er ikki sett upp í hesi distro",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli er sett upp men kundi ikki koyra",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.aidev_cli.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.aidev_cli.tagline": "Álítandi optimerað modell",
  "dialog.provider.aidevCliGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.aidevCliZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.aidevCliZen.visit.prefix": "Vitja ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í AidevCLI.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í aidev_cli.json",
  ...
  "dialog.server.description": "Skift hvønn AidevCLI ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna AidevCLI í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring AidevCLI í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør AidevCLI í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI er klárt í {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set AidevCLI upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn AidevCLI kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani AidevCLI aftur.",
  ...
  "help.tabs.introduction": "AidevCLI Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av AidevCLI ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til AidevCLI toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (aidev_cli.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, AidevCLI stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "AidevCLI Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr AidevCLI ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri AidevCLI",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu AidevCLI sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um AidevCLI fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu AidevCLI er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá AidevCLI byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av AidevCLI.",
