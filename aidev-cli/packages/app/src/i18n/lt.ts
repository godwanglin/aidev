...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "AidevCLI įkelti nepavyko",
  "AidevCLI langas netikėtai užsidarė",
  "AidevCLI neatsako",
  ...
  "AidevCLI įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "aidev-cli šiame distributyve neįdiegtas",
  "aidev-cli įdiegtas, bet jo paleisti nepavyko",
  "AidevCLI neįdiegtas distributyve {{distro}}",
  "AidevCLI naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.aidev_cli.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.aidevCliGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami AidevCLI modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.aidevCliZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.aidevCliZen.visit.prefix": "Aplankykite",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius AidevCLI.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti aidev_cli.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio AidevCLI serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama AidevCLI {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas AidevCLI {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite AidevCLI {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI yra paruoštas {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite AidevCLI į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad AidevCLI galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują AidevCLI ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą AidevCLI komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (aidev_cli.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad AidevCLI dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "AidevCLI apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "AidevCLI darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite AidevCLI serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite AidevCLI ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip AidevCLI atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar AidevCLI seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite AidevCLI temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią AidevCLI versiją.",
