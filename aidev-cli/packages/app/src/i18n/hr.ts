...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "AidevCLI se nije uspio učitati",
  "Prozor aplikacije AidevCLI neočekivano je zatvoren",
  "AidevCLI ne reagira",
  ...
  "Instalacija aplikacije AidevCLI nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "aidev-cli nije instaliran u ovoj distribuciji",
  "aidev-cli je instaliran, ali se ne može pokrenuti",
  "AidevCLI nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije AidevCLI je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.aidev_cli.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.aidevCliGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Posjetiti",
  "provider.connect.aidevCliZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u AidevCLI.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u aidev_cli.json",
  ...
  "dialog.server.description": "Promijenite na koji se AidevCLI poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera AidevCLI u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje AidevCLI u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte AidevCLI u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI je spreman u {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte AidevCLI u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte AidevCLI",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što AidevCLI može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite AidevCLI.",
  ...
  "help.tabs.introduction": "Radna površina AidevCLI sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija AidevCLI ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku AidevCLI timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (aidev_cli.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, AidevCLI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "AidevCLI Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite AidevCLI poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za AidevCLI",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako AidevCLI izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li AidevCLI slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je AidevCLI tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se AidevCLI pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju AidevCLI.",
