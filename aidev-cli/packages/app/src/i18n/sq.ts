export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni AidevCLI",
  ...
  "desktop.menu.ariaLabel": "Menuja AidevCLI",
  ...
  "desktop.recovery.loadFailed": "AidevCLI nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja AidevCLI u mbyll papritur",
  "desktop.recovery.unresponsive": "AidevCLI nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i AidevCLI dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.aidevCliMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.aidevCliCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i AidevCLI përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.aidev_cli.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.aidevCliGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Vizitoni ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në AidevCLI.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në aidev_cli.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server AidevCLI lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon AidevCLI në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "AidevCLI po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson AidevCLI në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso AidevCLI në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI është gati në {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni AidevCLI në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se AidevCLI të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i AidevCLI ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i AidevCLI",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (aidev_cli.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, AidevCLI nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin AidevCLI brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për AidevCLI",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket AidevCLI në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse AidevCLI ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të AidevCLI.",
