export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do AidevCLI",
  ...
  "desktop.menu.ariaLabel": "Menu do AidevCLI",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o AidevCLI",
  "desktop.recovery.terminated": "A janela do AidevCLI foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O AidevCLI não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do AidevCLI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.aidevCliMissing": "O aidev_cli não está instalado nesta distribuição",
  "desktop.wsl.error.aidevCliCannotRun": "O aidev_cli está instalado, mas não pôde ser executado",
  "desktop.wsl.error.aidevCliNotInstalled": "O AidevCLI não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do AidevCLI foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.aidev_cli.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.aidevCliGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Visite ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no AidevCLI.",
  ...
  "dialog.plugins.empty": "Plugins configurados em aidev_cli.json",
  ...
  "dialog.server.description": "Trocar para qual servidor AidevCLI este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o AidevCLI em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o AidevCLI em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o AidevCLI em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "O AidevCLI está pronto em {{distro}}.",
  "wsl.onboarding.aidevCliReady": "O AidevCLI está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o AidevCLI em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o AidevCLI possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O AidevCLI não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o AidevCLI novamente.",
  ...
  "help.tabs.introduction": "Agora, o AidevCLI Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do AidevCLI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do AidevCLI",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (aidev_cli.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: AidevCLI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor AidevCLI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do AidevCLI",
  ...
  "settings.general.row.appearance.description": "Personalize como o AidevCLI aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o AidevCLI segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o AidevCLI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o AidevCLI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do AidevCLI.",
