export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka AidevCLI",
  ...
  "desktop.recovery.loadFailed": "AidevCLI se nepodařilo načíst",
  "desktop.recovery.terminated": "AidevCLI okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "AidevCLI nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli není v této distribuci nainstalováno",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.aidev_cli.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.aidevCliGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Návštěva ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v AidevCLI.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v aidev_cli.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému AidevCLI serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola AidevCLI v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace AidevCLI v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace AidevCLI v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI je připraveno v {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte AidevCLI do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než AidevCLI může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze AidevCLI ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu AidevCLI",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (aidev_cli.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: AidevCLI zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server AidevCLI uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro AidevCLI",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled AidevCLI na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude AidevCLI následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi AidevCLI.",
