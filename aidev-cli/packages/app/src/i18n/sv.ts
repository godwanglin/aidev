export const dict = {
  ...
  "desktop.recovery.loadFailed": "AidevCLI kunde inte läsas in",
  "desktop.recovery.terminated": "AidevCLI-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "AidevCLI svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av AidevCLI misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli är inte installerat i den här distributionen",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli är installerat men kunde inte köras",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.aidev_cli.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.aidev_cli.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.aidevCliGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.aidevCliZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.aidevCliZen.visit.prefix": "Besök ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i AidevCLI.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i aidev_cli.json",
  ...
  "dialog.server.description": "Växla vilken AidevCLI-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar AidevCLI i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar AidevCLI i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera AidevCLI i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI är redo i {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera AidevCLI i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan AidevCLI kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan AidevCLI igen.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av AidevCLI ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till AidevCLI-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (aidev_cli.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, AidevCLI stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör AidevCLI-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för AidevCLI",
  ...
  "settings.general.row.appearance.description": "Anpassa hur AidevCLI ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om AidevCLI följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa AidevCLIs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när AidevCLI startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av AidevCLI.",
