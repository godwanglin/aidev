export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za AidevCLI",
  ...
  "desktop.menu.ariaLabel": "AidevCLI meni",
  ...
  "desktop.recovery.loadFailed": "AidevCLI se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor AidevCLI-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "AidevCLI ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija AidevCLI-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje AidevCLI-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.aidev_cli.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.aidevCliGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AidevCLI-u.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Posjeti ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u AidevCLI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AidevCLI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u aidev_cli.json",
  ...
  "dialog.server.description": "Promijeni na koji se AidevCLI server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera AidevCLI u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje AidevCLI u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj AidevCLI u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj AidevCLI u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi AidevCLI mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija AidevCLI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AidevCLI timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (aidev_cli.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AidevCLI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AidevCLI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u AidevCLI-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako AidevCLI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AidevCLI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AidevCLI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AidevCLI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AidevCLI-a.",
