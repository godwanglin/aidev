...
export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "AidevCLI-meny",
  ...
  "desktop.recovery.loadFailed": "AidevCLI kunne ikke lastes inn",
  "desktop.recovery.terminated": "AidevCLI-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "AidevCLI svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av AidevCLI mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli er ikke installert i denne distribusjonen",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli er installert, men kunne ikke kjøres",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av AidevCLI er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.aidev_cli.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.aidevCliGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Besøk ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i AidevCLI.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i aidev_cli.json",
  ...
  "dialog.server.description": "Bytt hvilken AidevCLI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av AidevCLI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til AidevCLI-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (aidev_cli.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at AidevCLI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør AidevCLI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for AidevCLI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan AidevCLI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om AidevCLI skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når AidevCLI starter",
  ...
  "settings.updates.toast.latest.title": "AidevCLI er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av AidevCLI.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker AidevCLI i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer AidevCLI i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater AidevCLI i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI er klar i {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer AidevCLI i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før AidevCLI kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter AidevCLI på nytt.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
