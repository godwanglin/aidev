export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "AidevCLI մենյու",
  ...
  "desktop.recovery.loadFailed": "AidevCLI չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "AidevCLI պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "AidevCLI-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.aidev_cli.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.aidevCliGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և AidevCLI-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Այցելություն ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և AidevCLI-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և AidevCLI-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են aidev_cli.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ AidevCLI սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է AidevCLI-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է AidevCLI-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել AidevCLI-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.aidevCliReady": "AidevCLI պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք AidevCLI-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի AidevCLI-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք AidevCLI։",
  ...
  "help.tabs.introduction": "AidevCLI Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AidevCLI-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին AidevCLI թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (aidev_cli.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ AidevCLI-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "AidevCLI ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք AidevCLI սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն AidevCLI",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է AidevCLI տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ AidevCLI-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է AidevCLI-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ AidevCLI-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք AidevCLI-ի վերջին տարբերակը։",
