export const dict = {
  ...
  "desktop.recovery.loadFailed": "AidevCLI laadimine ebaõnnestus",
  "desktop.recovery.terminated": "AidevCLI aken suleti ootamatult",
  "desktop.recovery.unresponsive": "AidevCLI ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli pole sellesse distrosse installitud",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.aidev_cli.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.aidevCliGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid AidevCLI'is.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Külastage ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises AidevCLI.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis aidev_cli.json",
  ...
  "dialog.server.description": "Lülitage, millise AidevCLI serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "AidevCLI kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "AidevCLI värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "AidevCLI värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda AidevCLI jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI on valmis {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige AidevCLI asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui AidevCLI saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse AidevCLI ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast AidevCLI meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (aidev_cli.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, AidevCLI ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "AidevCLI Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage AidevCLI server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke AidevCLI kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas AidevCLI teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas AidevCLI järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas AidevCLI on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui AidevCLI käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse AidevCLI uusimat versiooni.",
