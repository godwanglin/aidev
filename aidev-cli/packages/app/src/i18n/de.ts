...
export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.aidev_cli.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.aidevCliGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in AidevCLI zu nutzen.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in AidevCLI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in AidevCLI zu nutzen.",
  ...
  "dialog.plugins.empty": "In aidev_cli.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den AidevCLI-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "AidevCLI in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "AidevCLI wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "AidevCLI in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie AidevCLI in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AidevCLI aktualisieren",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI ist in {{distro}} bereit.",
  "wsl.onboarding.aidevCliReady": "AidevCLI ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie AidevCLI in {{distro}}.",
  "wsl.onboarding.installOpencode": "AidevCLI installieren",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor AidevCLI einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann AidevCLI erneut.",
  ...
  "toast.update.description": "Eine neue Version von AidevCLI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem AidevCLI-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (aidev_cli.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: AidevCLI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "AidevCLI mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "AidevCLI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "AidevCLI Desktop",
  ...
  "settings.desktop.wsl.description": "AidevCLI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für AidevCLI ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie AidevCLI auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob AidevCLI dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von AidevCLI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von AidevCLI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "AidevCLI ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von AidevCLI wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "AidevCLI konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das AidevCLI-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "AidevCLI reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das AidevCLI-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "AidevCLI Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
