...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða AidevCLI",
  "AidevCLI-glugganum var óvænt lokað",
  "AidevCLI svarar ekki",
  ...
  "Uppsetning AidevCLI mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "aidev-cli er ekki uppsett í þessari dreifingu",
  "aidev-cli er uppsett en ekki var hægt að keyra það",
  "AidevCLI er ekki uppsett í {{distro}}",
  "Uppfærslu AidevCLI lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.aidev_cli.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.aidevCliGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.aidevCliZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.aidevCliZen.visit.prefix": "Heimsókn",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í AidevCLI.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í aidev_cli.json",
  ...
  "dialog.server.description": "Skiptu um hvaða AidevCLI miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar AidevCLI í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir AidevCLI í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu AidevCLI í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI er tilbúið í {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp AidevCLI í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en AidevCLI getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan AidevCLI aftur.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af AidevCLI ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til AidevCLI teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (aidev_cli.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, AidevCLI styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "AidevCLI inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "AidevCLI skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu AidevCLI netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir AidevCLI",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig AidevCLI lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort AidevCLI fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig AidevCLI er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar AidevCLI ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af AidevCLI.",
