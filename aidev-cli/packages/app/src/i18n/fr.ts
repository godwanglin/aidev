export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'AidevCLI",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'AidevCLI",
  "desktop.recovery.terminated": "La fenêtre AidevCLI s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "AidevCLI ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'AidevCLI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli n'est pas installé dans cette distribution",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'AidevCLI est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.aidev_cli.tagline": "Modèles optimisés et fiables",
  "dialog.provider.aidevCliGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Visitez ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans AidevCLI.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans aidev_cli.json",
  ...
  "dialog.server.description": "Changez le serveur AidevCLI auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'AidevCLI dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'AidevCLI dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour AidevCLI dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI est prêt dans {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez AidevCLI dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'AidevCLI puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'AidevCLI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe AidevCLI",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (aidev_cli.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'AidevCLI ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "AidevCLI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur AidevCLI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour AidevCLI",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'AidevCLI sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si AidevCLI suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'AidevCLI.",
