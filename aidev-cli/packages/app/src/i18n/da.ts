export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.aidev_cli.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.aidevCliGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.aidevCliZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.aidevCliZen.visit.prefix": "Besøg ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i AidevCLI.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i aidev_cli.json",
  ...
  "dialog.server.description": "Skift hvilken AidevCLI-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker AidevCLI i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer AidevCLI i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater AidevCLI i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før AidevCLI kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter AidevCLI igen.",
  ...
  "toast.update.description": "En ny version af AidevCLI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til AidevCLI-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (aidev_cli.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, AidevCLI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør AidevCLI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for AidevCLI",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan AidevCLI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om AidevCLI skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas AidevCLIs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når AidevCLI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af AidevCLI.",
  ...
  "desktop.recovery.loadFailed": "AidevCLI kunne ikke indlæses",
  "desktop.recovery.terminated": "AidevCLI-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af AidevCLI mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli er ikke installeret i denne distribution",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli er installeret, men kunne ikke køre",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af AidevCLI er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "AidevCLI Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
