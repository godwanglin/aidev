...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "AidevCLI failed to load",
  "desktop.recovery.terminated": "AidevCLI window terminated unexpectedly",
  "desktop.recovery.unresponsive": "AidevCLI is not responding",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli is not installed in this distro",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli is installed but could not run",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AidevCLI update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
