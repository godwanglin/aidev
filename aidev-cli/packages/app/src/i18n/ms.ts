export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi AidevCLI",
  ...
  "desktop.recovery.loadFailed": "AidevCLI gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap AidevCLI ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "AidevCLI tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan AidevCLI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli tidak dipasang dalam distro ini",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini AidevCLI selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.aidev_cli.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.aidevCliGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Layari",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam AidevCLI.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam aidev_cli.json",
  ...
  "dialog.server.description": "Tukar pelayan AidevCLI yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak AidevCLI dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini AidevCLI dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini AidevCLI dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang AidevCLI dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum AidevCLI boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu AidevCLI ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan AidevCLI",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (aidev_cli.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, AidevCLI belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan AidevCLI dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk AidevCLI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa AidevCLI pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada AidevCLI mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila AidevCLI dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini AidevCLI.",
