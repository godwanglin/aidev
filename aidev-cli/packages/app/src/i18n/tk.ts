export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI Resminamalar",
  ...
  "desktop.menu.ariaLabel": "AidevCLI menýusy",
  ...
  "desktop.recovery.loadFailed": "AidevCLI ýükläp bilmedi",
  "desktop.recovery.terminated": "AidevCLI penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "AidevCLI jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.aidevCliMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "AidevCLI täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.aidev_cli.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.aidevCliGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLI tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we AidevCLI-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Sapar ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini AidevCLI-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini AidevCLI-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "aidev_cli.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy AidevCLI serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde AidevCLI barlanýar...",
  "wsl.onboarding.updatingOpencode": "AidevCLI täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de AidevCLI täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "AidevCLI-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "AidevCLI täzeläň",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI {{distro}}-de taýýar.",
  "wsl.onboarding.aidevCliReady": "AidevCLI taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de AidevCLI guruň.",
  "wsl.onboarding.installOpencode": "AidevCLI guruň",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) AidevCLI WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra AidevCLI açyň.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin AidevCLI ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy AidevCLI toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (aidev_cli.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, AidevCLI entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "AidevCLI serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "AidevCLI üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "AidevCLI enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "AidevCLI ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "AidevCLI-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "AidevCLI işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "AidevCLI-iň iň soňky wersiýasyny işleýärsiňiz.",
