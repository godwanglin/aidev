export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI-documentatie",
  ...
  "desktop.recovery.loadFailed": "AidevCLI kan niet worden geladen",
  "desktop.recovery.terminated": "Het AidevCLI-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "AidevCLI reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van AidevCLI is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De AidevCLI-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.aidev_cli.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.aidevCliGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in AidevCLI te gebruiken.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.aidevCliZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.aidevCliZen.visit.prefix": "Ga naar ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in AidevCLI te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in AidevCLI te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in aidev_cli.json",
  ...
  "dialog.server.description": "Wijzig met welke AidevCLI-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI controleren...",
  "wsl.onboarding.checkingOpencodeIn": "AidevCLI controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "AidevCLI bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "AidevCLI bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk AidevCLI bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AidevCLI bijwerken",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI is gereed in {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer AidevCLI in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat AidevCLI een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens AidevCLI opnieuw.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van AidevCLI ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het AidevCLI-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (aidev_cli.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: AidevCLI ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de AidevCLI-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor AidevCLI",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe AidevCLI eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of AidevCLI het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van AidevCLI aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer AidevCLI wordt gestart",
  ...
  "settings.updates.toast.latest.title": "AidevCLI is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van AidevCLI.",
