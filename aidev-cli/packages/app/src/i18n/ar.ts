export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل AidevCLI",
  "desktop.recovery.terminated": "توقفت نافذة AidevCLI بشكل غير متوقع",
  "desktop.recovery.unresponsive": "AidevCLI لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت AidevCLI",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث AidevCLI، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.aidev_cli.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.aidevCliGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "يمنحك AidevCLI Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "قم بزيارة ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في AidevCLI.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في aidev_cli.json",
  ...
  "dialog.server.description": "تبديل خادم AidevCLI الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من AidevCLI في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث AidevCLI في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث AidevCLI في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI جاهز في {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت AidevCLI في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن AidevCLI من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على AidevCLI التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح AidevCLI.",
  ...
  "help.tabs.introduction": "أصبح AidevCLI Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من AidevCLI ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق AidevCLI",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (aidev_cli.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن AidevCLI لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن AidevCLI نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم AidevCLI داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ AidevCLI",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور AidevCLI على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان AidevCLI يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة AidevCLI.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل AidevCLI",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من AidevCLI.",
