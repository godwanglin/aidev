export const dict = {
  ...
  "desktop.menu.documentation": "Documentație AidevCLI",
  ...
  "desktop.menu.ariaLabel": "Meniu AidevCLI",
  ...
  "desktop.recovery.loadFailed": "AidevCLI nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra AidevCLI s-a închis neașteptat",
  "desktop.recovery.unresponsive": "AidevCLI nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea AidevCLI a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli nu este instalat în această distribuție",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea AidevCLI s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.aidev_cli.tagline": "Modele optimizate, fiabile",
  "dialog.provider.aidevCliGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.aidevCliZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.aidevCliZen.visit.prefix": "Vizitează",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în AidevCLI.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în aidev_cli.json",
  ...
  "dialog.server.description": "Schimbă serverul AidevCLI la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică AidevCLI în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează AidevCLI în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează AidevCLI în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI este gata în {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează AidevCLI în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca AidevCLI să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune AidevCLI ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei AidevCLI",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (aidev_cli.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, AidevCLI nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul AidevCLI în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru AidevCLI",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul AidevCLI pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă AidevCLI urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune AidevCLI.",
