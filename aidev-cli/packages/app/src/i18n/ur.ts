export const dict = {
  ...
  "desktop.menu.documentation": "AidevCLI دستاویزات",
  ...
  "desktop.menu.ariaLabel": "AidevCLI مینو",
  ...
  "desktop.recovery.loadFailed": "AidevCLI لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "AidevCLI ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "AidevCLI جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.aidevCliMissing": "اس ڈسٹری بیوشن میں aidev_cli انسٹال نہیں ہے",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.aidevCliNotInstalled": "{{distro}} میں AidevCLI انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "AidevCLI کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.aidev_cli.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.aidev_cli.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.aidevCliGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLI کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور AidevCLI میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور AidevCLI میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور AidevCLI میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "aidev_cli.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس AidevCLI سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں AidevCLI چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "AidevCLI کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں AidevCLI کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں AidevCLI کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "AidevCLI کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI {{distro}} میں تیار ہے۔",
  "wsl.onboarding.aidevCliReady": "AidevCLI تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں AidevCLI انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "AidevCLI انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ AidevCLI WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر AidevCLI کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "AidevCLI Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AidevCLI ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم AidevCLI ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (aidev_cli.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، AidevCLI ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "AidevCLI ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر AidevCLI سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "AidevCLI کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر AidevCLI کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا AidevCLI سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "AidevCLI کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "AidevCLI لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ AidevCLI کا تازہ ترین ورژن چلا رہے ہیں۔",
