export const dict = {
  ...
  "dialog.provider.aidev_cli.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.aidev_cli.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.aidevCliGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.aidevCliZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.aidevCliZen.visit.prefix": "Visita ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in AidevCLI.",
  ...
  "dialog.plugins.empty": "Plugin configurati in aidev_cli.json",
  ...
  "dialog.server.description": "Cambia il server AidevCLI a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo AidevCLI in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento AidevCLI in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna AidevCLI in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI è pronto in {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa AidevCLI in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che AidevCLI possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di AidevCLI ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team AidevCLI",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (aidev_cli.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: AidevCLI non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server AidevCLI all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per AidevCLI",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di AidevCLI sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se AidevCLI segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di AidevCLI",
  ...
  "settings.updates.toast.latest.title": "AidevCLI è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di AidevCLI.",
  ...
  "desktop.menu.documentation": "Documentazione di AidevCLI",
  ...
  "desktop.menu.ariaLabel": "Menu AidevCLI",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare AidevCLI",
  "desktop.recovery.terminated": "La finestra di AidevCLI si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "AidevCLI non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di AidevCLI non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli non è installato in questa distribuzione",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di AidevCLI è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
