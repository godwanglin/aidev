...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AidevCLI yüklenemedi",
  "desktop.recovery.terminated": "AidevCLI penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "AidevCLI yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli bu dağıtımda kurulu değil",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "AidevCLI güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.aidev_cli.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.aidevCliGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AidevCLI'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.aidevCliZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak AidevCLI'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AidevCLI'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler aidev_cli.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AidevCLI sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde AidevCLI kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "AidevCLI güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde AidevCLI güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki AidevCLI'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "AidevCLI'u güncelle",
  "wsl.onboarding.aidevCliReadyIn": "{{distro}} içinde AidevCLI hazır.",
  "wsl.onboarding.aidevCliReady": "AidevCLI hazır.",
  "wsl.onboarding.installOpencodeIn": "AidevCLI'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "AidevCLI'u kur",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AidevCLI'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından AidevCLI'u tekrar açın.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AidevCLI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AidevCLI ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (aidev_cli.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: AidevCLI henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "AidevCLI Masaüstü",
  ...
  "settings.desktop.wsl.description": "AidevCLI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AidevCLI'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "AidevCLI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AidevCLI'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AidevCLI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AidevCLI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AidevCLI'un en son sürümünü kullanıyorsunuz.",
