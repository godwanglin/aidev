export const dict = {
  ...
  "desktop.recovery.loadFailed": "AidevCLI yüklənə bilmədi",
  "desktop.recovery.terminated": "AidevCLI pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "AidevCLI cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "AidevCLI quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.aidevCliMissing": "Bu distribütivdə aidev_cli quraşdırılmayıb",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "AidevCLI yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.aidev_cli.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.aidevCliGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "AidevCLI tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və AidevCLI-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və AidevCLI-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və AidevCLI-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər aidev_cli.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu AidevCLI serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "AidevCLI yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də AidevCLI yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "AidevCLI yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də AidevCLI yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də AidevCLI-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "AidevCLI-u yeniləyin",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI {{distro}}-də hazırdır.",
  "wsl.onboarding.aidevCliReady": "AidevCLI hazırdır.",
  "wsl.onboarding.installOpencodeIn": "AidevCLI-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "AidevCLI quraşdırın",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AidevCLI WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra AidevCLI-u yenidən açın.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AidevCLI-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı AidevCLI komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (aidev_cli.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: AidevCLI hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində AidevCLI serverini işlət.",
  ...
  "settings.general.row.language.description": "AidevCLI üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "AidevCLI-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "AidevCLI-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "AidevCLI-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "AidevCLI açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "AidevCLI-un ən son versiyasından istifadə edirsiniz.",
