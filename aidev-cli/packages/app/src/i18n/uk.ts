export const dict = {
  ...
  "desktop.menu.documentation": "Документація AidevCLI",
  ...
  "desktop.menu.ariaLabel": "Меню AidevCLI",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити AidevCLI",
  "desktop.recovery.terminated": "Роботу вікна AidevCLI несподівано завершено",
  "desktop.recovery.unresponsive": "AidevCLI не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити AidevCLI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.aidevCliMissing": "aidev-cli не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.aidevCliCannotRun": "aidev-cli встановлено, але його не вдалося запустити",
  "desktop.wsl.error.aidevCliNotInstalled": "AidevCLI не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення AidevCLI завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.aidev_cli.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.aidev_cli.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.aidevCliGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від AidevCLI",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у AidevCLI.",
  ...
  "provider.connect.aidevCliZen.line1":
    "AidevCLI Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.aidevCliZen.visit.prefix": "Відвідайте ",
  "provider.connect.aidevCliZen.visit.link": "aidev_cli.ai/zen",
  "provider.connect.aidevCliZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у AidevCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у AidevCLI.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в aidev_cli.json",
  ...
  "dialog.server.description": "Перемкніть сервер AidevCLI, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка AidevCLI...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка AidevCLI у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення AidevCLI...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення AidevCLI у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть AidevCLI у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити AidevCLI",
  "wsl.onboarding.aidevCliReadyIn": "AidevCLI готовий до роботи у {{distro}}.",
  "wsl.onboarding.aidevCliReady": "AidevCLI готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть AidevCLI у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити AidevCLI",
  ...
  "wsl.onboarding.distroStatus.aidevCliMissing": "AidevCLI не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в AidevCLI потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "AidevCLI не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте AidevCLI.",
  ...
  "help.tabs.introduction": "AidevCLI Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія AidevCLI ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді AidevCLI",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (aidev_cli.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, AidevCLI ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "AidevCLI містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер AidevCLI всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу AidevCLI",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд AidevCLI на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи AidevCLI використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему AidevCLI.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску AidevCLI",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію AidevCLI.",
