...
const GLOBAL_STORAGE = "aidev_cli.global.dat"
const WINDOW_STORAGE = "aidev_cli.window"
const LOCAL_PREFIX = "aidev_cli."
...
function workspaceStorage(dir: string) {
  ...
  return `aidev_cli.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `aidev_cli.draft.${head}.${sum}.dat`
}
