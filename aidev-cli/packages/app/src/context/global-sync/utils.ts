...
import type { Agent, PermissionRequest, Project, Provider, ProviderListResponse } from "@aidev-cli/sdk/v2/client"
import type { Project as CurrentProject } from "@aidev-cli/client/promise"
