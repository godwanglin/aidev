...
import type { Config, OpencodeClient, Project } from "@aidev-cli/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@aidev-cli/client/promise"
import type { NormalizedProviderListResponse } from "@aidev-cli/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
