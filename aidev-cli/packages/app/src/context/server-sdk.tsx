import type { AidevCLIEvent } from "@aidev-cli/client/promise"
import type { Event } from "@aidev-cli/sdk/v2/client"
...
export type ServerEvent = Event & { current?: AidevCLIEvent }
...
export function adaptServerEvent(event: AidevCLIEvent): ServerEvent {
...
function currentDelta(event: AidevCLIEvent | undefined): CurrentDelta | undefined {
  if (
