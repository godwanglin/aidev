...
import type { retry } from "@aidev-cli/core/util/retry"
import type { AidevCLIEvent, SessionApi } from "@aidev-cli/client/promise"
import type { Message, OpencodeClient, Part, Session } from "@aidev-cli/sdk/v2/client"
...
describe("server session", () => {
  test("projects V2 session events into current and legacy message state", () => {
    ...
    const apply = (input: object) => ctx.store.applyV2(input as AidevCLIEvent)
