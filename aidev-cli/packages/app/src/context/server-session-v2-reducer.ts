import type { AidevCLIEvent, SessionMessageInfo, SessionPendingMessage } from "@aidev-cli/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: AidevCLIEvent): V2SessionReduction | undefined => {
