...
import { base64Encode } from "@aidev-cli/core/util/encode"
...
import { Session } from "@aidev-cli/sdk/v2/client"
...
import { retry } from "@aidev-cli/core/util/retry"
...
import { useTheme, type ColorScheme } from "@aidev-cli/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://aidev_cli.ai/desktop-feedback")}
      renderPanel={() =>
