import { useFilteredList } from "@aidev-cli/ui/hooks"
import { useSpring } from "@aidev-cli/ui/motion-spring"
import {
  createEffect,
  on,
  Component,
...
import { DockShellForm, DockTray } from "@aidev-cli/ui/dock-surface"
import { Icon } from "@aidev-cli/ui/icon"
import { ProviderIcon } from "@aidev-cli/ui/provider-icon"
import { Tooltip, TooltipKeybind } from "@aidev-cli/ui/tooltip"
...
import { KeybindV2 } from "@aidev-cli/ui/v2/keybind-v2"
...
import type { ReferenceInfo } from "@aidev-cli/sdk/v2/client"
  ...
  const createPill = (part: FileAttachmentPart | AgentPart) => {
    ...
    if (part.type === "file") {
      ...
      if (part.source?.type === "resource") {
        ...
        pill.setAttribute("data-sourceClient-name", part.source.clientName)
