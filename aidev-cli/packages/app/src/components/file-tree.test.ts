...
beforeAll(async () => {
  ...
  mock.module("@aidev-cli/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@aidev-cli/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@aidev-cli/ui/icon", () => ({ Icon: () => null }))
  mock.module("@aidev-cli/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
