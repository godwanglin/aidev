...
import type { Session } from "@aidev-cli/sdk/v2"
    ...
    >
      ...
      >
        ...
        <span
          ...
          classList={{
            "overflow-hidden textClip whitespace-nowrap": !editing(),
            "select-text": editing(),
          }}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          data-titlebar-tab-title
          class="min-w-0 flex-1 overflow-hidden textClip whitespace-nowrap outline-none leading-4"
        >
          {props.title}
        </span>
      </a>
