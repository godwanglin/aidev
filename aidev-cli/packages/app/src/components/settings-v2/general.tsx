...
import { Switch } from "@aidev-cli/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://aidev_cli.ai/docs/themes/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_AIDEV_CLI_CHANNEL !== "prod"}>
          <SettingsRowV2
