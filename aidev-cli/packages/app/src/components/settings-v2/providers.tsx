...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "aidev-cli", key: "dialog.provider.aidev_cli.note" },
  { match: (id: string) => id === "aidev-cli-go", key: "dialog.provider.aidevCliGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "aidev-cli" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "aidev-cli" || item.id === "aidev-cli-go"}>
