...
import { showToast } from "@aidev-cli/ui/toast"
import { ButtonV2 } from "@aidev-cli/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@aidev-cli/ui/v2/dialog-v2"
import { DividerV2 } from "@aidev-cli/ui/v2/divider-v2"
import { LoaderV2 } from "@aidev-cli/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@aidev-cli/ui/v2/radio-v2"
      ...
      <div class="settings-v2-wsl-not-installed-content">
        <div class="settings-v2-wsl-not-installed-message">
          <svg
            ...
            aria-hidden="true"
          >
            <g clip-path="url(#settings-v2-wsl-warningClip)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            <defs>
              <clipPath id="settings-v2-wsl-warningClip">
