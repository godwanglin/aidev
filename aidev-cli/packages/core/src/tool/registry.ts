...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@aidev-cli/llm"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/v2/ToolRegistry") {}
