...
import { Entry, FileSystem, FindInput, Match } from "@aidev-cli/schema/filesystem"
export { Entry, Match, Submatch } from "@aidev-cli/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/v2/FileSystem") {}
