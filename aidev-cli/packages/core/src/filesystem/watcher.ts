...
import { FileSystemWatcher } from "@aidev-cli/schema/filesystem-watcher"
...
declare const AIDEV_CLI_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof AIDEV_CLI_LIBC === "undefined" ? undefined : AIDEV_CLI_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.AIDEV_CLI_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.AIDEV_CLI_EXPERIMENTAL_FILEWATCHER)) {
