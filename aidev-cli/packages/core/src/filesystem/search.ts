...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.AIDEV_CLI_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
