...
import { Credential } from "@aidev-cli/schema/credential"
import { Integration } from "@aidev-cli/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/v2/Credential") {}
