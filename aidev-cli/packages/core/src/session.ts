...
import { ListAnchor } from "@aidev-cli/schema/session"
...
import { SessionDurable } from "@aidev-cli/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/v2/Session") {}
