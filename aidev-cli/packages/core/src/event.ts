...
import type { Data, Definition, Payload } from "@aidev-cli/schema/event"
...
import { Durable } from "@aidev-cli/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@aidev-cli/schema/event").ID
export type { Data, Definition, Payload } from "@aidev-cli/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/Event") {}
