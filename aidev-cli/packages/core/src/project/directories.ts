...
import type { EffectDrizzleSqlite } from "@aidev-cli/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/ProjectDirectories") {}
