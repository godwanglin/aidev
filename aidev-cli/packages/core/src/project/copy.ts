...
import { Event } from "@aidev-cli/schema/project-directories"
import { ProjectCopy } from "@aidev-cli/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/ProjectCopy") {}
