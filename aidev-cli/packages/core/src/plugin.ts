...
import type { Plugin as PluginRuntime } from "@aidev-cli/plugin/v2/effect"
import { Plugin } from "@aidev-cli/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/v2/Plugin") {}
