...
import defaultSoundPath from "@aidev-cli/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@aidev-cli/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@aidev-cli/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@aidev-cli/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@aidev-cli/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@aidev-cli/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "aidev-cli"
const DEFAULT_PACK_ID = "aidev_cli.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "AidevCLI Default",
  builtin: true,
  sounds: {
