...
import { useBindings, useaidevCliModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useaidevCliModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.AIDEV_CLI_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
