...
import { registerAidevSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@aidev-cli/sdk/v2"
...
import { AIDEV_CLI_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useAidevKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.AIDEV_CLI_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
