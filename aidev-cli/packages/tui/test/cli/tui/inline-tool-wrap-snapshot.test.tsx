...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "AIDEV_CLI.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/aidev-cli/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/aidev-cli (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/aidev-cli/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/aidev-cli/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const AIDEV_CLI_DB|AIDEV_CLI_DB|AIDEV_CLI_DEV|Global\\.Path\\.data|data =" in packages/aidev-cli/src (115 matches)',
  },
] as const
