import { AidevCLI } from "@aidev-cli/client/effect"
...
import { createEmbeddedRoutes } from "@aidev-cli/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("AidevCLI.create")(function* () {
  ...
  const client = yield* AidevCLI.make({ baseUrl: "http://aidev_cli.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/sdk-next/AidevCLI") {}
