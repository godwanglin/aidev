...
import { EventSequenceTable, EventTable } from "@aidev-cli/core/event/sql"
...
import { WorkspaceEvent } from "@aidev-cli/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AIDEV_CLI_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AIDEV_CLI_WORKSPACE_ID: config.id,
        AIDEV_CLI_EXPERIMENTAL_WORKSPACES: "true",
