...
import type { AssistantMessage as AidevCLIAssistantMessage, Message } from "@aidev-cli/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@aidev-cli/core/effect/app-node"
...
export type AssistantTokenCost = Pick<AidevCLIAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<AidevCLIAssistantMessage, "role"> &
  Partial<Pick<AidevCLIAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@aidev-cli/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@aidev-cli/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@aidev-cli/ACPUsage") {}
