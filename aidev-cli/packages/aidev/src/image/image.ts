...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AIDEV_CLI_PHOTON_WASM_PATH?: string }).__AIDEV_CLI_PHOTON_WASM_PATH =
