import type { Hooks, PluginInput } from "@aidev-cli/plugin"
import type { Model } from "@aidev-cli/sdk/v2"
import { InstallationVersion } from "@aidev-cli/core/installation/version"
import { OauthCallbackPage } from "@aidev-cli/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. AidevCLI will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
