...
import { path } from "@aidev-cli/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@aidev-cli/core/project"
...
import { WorktreeEvent } from "@aidev-cli/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `aidev-cli/${name}`
