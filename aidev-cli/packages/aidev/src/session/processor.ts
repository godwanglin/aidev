...
import { Usage, type LLMEvent } from "@aidev-cli/llm"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean aidev_cli changed history behind a signed
