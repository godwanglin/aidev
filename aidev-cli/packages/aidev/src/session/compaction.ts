...
import { buildPrompt } from "@aidev-cli/core/session/compaction"
import { SessionCompactionEvent } from "@aidev-cli/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/SessionCompaction") {}
