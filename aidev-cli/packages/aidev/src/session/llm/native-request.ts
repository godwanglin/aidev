import type { JsonSchema, LLMRequest, ProviderMetadata } from "@aidev-cli/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@aidev-cli/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @aidev-cli/llm request objects from aidev_cli's session/AI SDK-shaped data.
  return LLM.request({
