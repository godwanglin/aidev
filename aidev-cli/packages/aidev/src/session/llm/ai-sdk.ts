import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@aidev-cli/llm"
...
// Move this extraction into @aidev-cli/llm when Copilot is handled by the native runtime.
