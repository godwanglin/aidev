...
import { MAX_STEPS_PROMPT } from "@aidev-cli/core/session/runner/max-steps"
...
import { LLMEvent } from "@aidev-cli/llm"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/SessionPrompt") {}
