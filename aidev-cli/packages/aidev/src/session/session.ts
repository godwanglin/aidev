...
import { Slug } from "@aidev-cli/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@aidev-cli/llm"
...
import { locationServiceMapLayer } from "@aidev-cli/core/location-services"
...
import { PartTable, SessionTable } from "@aidev-cli/core/session/sql"
...
import { NonNegativeInt, optional } from "@aidev-cli/core/schema"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProviderV2 } from "@aidev-cli/core/provider"
import { ModelV2 } from "@aidev-cli/core/model"
import { SessionMessage } from "@aidev-cli/schema/session-message"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".aidev-cli", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/Session") {}
