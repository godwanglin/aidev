...
import { AccountStateTable, AccountTable } from "@aidev-cli/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/AccountRepo") {}
