...
export const SessionApi = HttpApi.make("session")
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all AidevCLI sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific AidevCLI session.",
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new AidevCLI session for interacting with AI assistants and managing conversations.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "aidev-cli experimental HttpApi",
      version: "0.0.1",
