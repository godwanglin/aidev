...
>()("@aidev-cli/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@aidev-cli/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.AIDEV_CLI_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.AIDEV_CLI_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-aidev-cli-directory"] || process.cwd()
}
