 ...
 *   "@aidev-cli/ServerAuthConfig",
 *   {
 *     password: Config.string("AIDEV_CLI_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AIDEV_CLI_SERVER_USERNAME").pipe(Config.withDefault("aidev-cli")),
 *   },
 * ) {}
 *
