...
import type * as SDK from "@aidev-cli/sdk/v2"
...
import { SessionShareTable } from "@aidev-cli/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/ShareNext") {}
