...
import { ProjectDirectoryTable, ProjectTable } from "@aidev-cli/core/project/sql"
import { ProjectDirectories } from "@aidev-cli/core/project/directories"
...
import { which } from "@aidev-cli/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.AIDEV_CLI_FAKE_VCS)
