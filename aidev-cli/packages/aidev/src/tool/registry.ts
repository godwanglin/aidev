...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@aidev-cli/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return (
    ...
    providerID === ProviderV2.ID.make("aidev-cli-go") ||
    flags.exa ||
    flags.parallel
  )
}
...
export class Service extends Context.Service<Service, Interface>()("@aidev-cli/ToolRegistry") {}
