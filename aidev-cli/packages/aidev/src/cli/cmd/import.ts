import type { Session as SDKSession, Message, Part } from "@aidev-cli/sdk/v2"
...
import { SessionTable, MessageTable, PartTable } from "@aidev-cli/core/session/sql"
...
/** Extract share ID from a share URL like /share/abc123 */
