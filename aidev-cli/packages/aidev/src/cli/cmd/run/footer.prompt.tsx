...
import { normalizePromptContent } from "@aidev-cli/tui/editor"
...
import { AIDEV_CLI_BASE_MODE, useBindings } from "@aidev-cli/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close AidevCLI" } satisfies SlashOption,
    ]
