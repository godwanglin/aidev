...
import type { Event, GlobalEvent, OpencodeClient } from "@aidev-cli/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@aidev-cli/RunStreamTransport") {}
