...
//
// The saved variant persists across sessions in ~/.local/state/aidev-cli/model.json
...
class Service extends Context.Service<Service, VariantService>()("@aidev-cli/RunVariant") {}
