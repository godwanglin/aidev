// Shared type vocabulary for the direct interactive mode (`aidev-cli --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@aidev-cli/sdk/v2"
