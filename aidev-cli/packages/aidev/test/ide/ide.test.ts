...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AIDEV_CLI_CALLER", () => {
    process.env["AIDEV_CLI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AIDEV_CLI_CALLER", () => {
    process.env["AIDEV_CLI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AIDEV_CLI_CALLER", () => {
    process.env["AIDEV_CLI_CALLER"] = "unknown"
