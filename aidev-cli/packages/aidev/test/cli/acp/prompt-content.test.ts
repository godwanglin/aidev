...
import { expectOk } from "./acp-testClient"
...
describe("aidev-cli acp prompt content subprocess", () => {
  cliIt.live(
    ...
    ({ home, llm, aidev_cli }) =>
      Effect.gen(function* () {
        ...
        const acp = yield* createAcpClient(
          { aidev_cli },
          { AIDEV_CLI_CONFIG_CONTENT: JSON.stringify(promptContentConfig(llm.url)) },
        )
