...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/aidev_cli.git")).toEqual({ owner: "sst", repo: "aidev-cli" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/aidev-cli")).toEqual({ owner: "sst", repo: "aidev-cli" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/aidev_cli.git")).toEqual({ owner: "sst", repo: "aidev-cli" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/aidev-cli")).toEqual({ owner: "sst", repo: "aidev-cli" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/aidev_cli.git")).toEqual({ owner: "sst", repo: "aidev-cli" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/aidev-cli")).toEqual({ owner: "sst", repo: "aidev-cli" })
})
