...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips aidev_cli-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-aidev-cli-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-aidev-cli-directory")).toBeNull()
      expect(result.get("x-aidev-cli-workspace")).toBeNull()
