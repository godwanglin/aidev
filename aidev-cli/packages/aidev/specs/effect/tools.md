...
Practical reference for the current tool-migration state in `packages/aidev-cli`.
...
Tool tests should use the existing Effect helpers in `packages/aidev-cli/test/lib/effect.ts`:
