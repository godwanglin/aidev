...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/aidev-cli`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy aidev-cli service removed
