...
import { compile, emitEffectImported, emitPromise, write } from "@aidev-cli/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "AidevCLIEventEncoded",
              import: 'import type { AidevCLIEventEncoded } from "@aidev-cli/protocol/groups/event"',
            },
          },
        }),
