...
Schema-first LLM core for aidev-cli. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@aidev-cli/llm"
import { OpenAI } from "@aidev-cli/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@aidev-cli/llm/providers"
