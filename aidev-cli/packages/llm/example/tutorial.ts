...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@aidev-cli/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@aidev-cli/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-aidev-cli-tutorial": "1" },
    query: { debug: "1" },
  },
})
