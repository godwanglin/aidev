...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[AidevCLI](https://aidev_cli.ai)")).toBe(
    '<p><a href="https://aidev_cli.ai" class="external-link" target="_blank" rel="noopener noreferrer">AidevCLI</a></p>\n',
  )
})
