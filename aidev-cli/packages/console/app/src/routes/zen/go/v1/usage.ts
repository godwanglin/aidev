...
import { and, Database, eq, isNull } from "@aidev-cli/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@aidev-cli/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "AidevCLI Go subscription required.",
        },
      }),
      {
        status: 403,
