...
import compareVideo from "../../asset/lander/aidev-cli-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/aidev-cli-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name=""aidev-cli":auth" content={loggedin() ? "true" : "false"} />
