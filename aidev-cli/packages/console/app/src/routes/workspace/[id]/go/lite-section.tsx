...
import { Database, eq, and, gte, isNull, sql } from "@aidev-cli/console-core/drizzle/index.js"
import { BillingTable, LiteTable, UsageTable } from "@aidev-cli/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#aidev-cli-go")} target="_blank" rel="noopener noreferrer">
