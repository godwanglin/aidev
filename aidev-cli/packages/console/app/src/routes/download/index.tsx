      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://aidev_cli.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>aidev_cli.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g aidev_cli")}>
                <code>
                  npm i -g <strong>aidev-cli</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g aidev_cli")}>
                <code>
                  bun add -g <strong>aidev-cli</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/aidev-cli")}>
                <code>
                  brew install <strong>anomalyco/tap/aidev-cli</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S aidev_cli")}>
                <code>
                  paru -S <strong>aidev-cli</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask aidev_cli-desktop")}>
                <code>
                  brew install --cask <strong>aidev-cli-desktop</strong>
                </code>
                <CopyStatus />
              </button>
