...
export const TypeId: TypeId = "~@aidev-cli/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@aidev-cli/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@aidev-cli/effect-sqlite-node/NodeSqliteClient")
