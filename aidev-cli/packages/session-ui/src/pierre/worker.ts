...
import { registerAidevCLITheme } from "@aidev-cli/ui/context/marked-theme-register"

registerAidevCLITheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for AidevCLI, as I think 8 might be
