...
declare const AIDEV_CLI_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof AIDEV_CLI_CLI_NAME === "string" ? AIDEV_CLI_CLI_NAME : "aidev-cli", {
  description: "AidevCLI 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
