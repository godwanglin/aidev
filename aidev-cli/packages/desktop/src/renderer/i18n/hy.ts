export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք AidevCLI-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLI-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «aidev-cli» հրամանն օգտագործելու համար:",
