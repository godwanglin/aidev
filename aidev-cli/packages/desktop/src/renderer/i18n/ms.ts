export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini AidevCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} AidevCLI telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
  ...
  "desktop.cli.installed.message":
    "CLI telah dipasang ke {{path}}\n\nMulakan semula terminal anda untuk menggunakan arahan 'aidev-cli'.",
