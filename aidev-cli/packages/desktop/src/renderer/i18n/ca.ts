export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'AidevCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'AidevCLI. Voleu instal·lar-la i reiniciar l'aplicació?",
  ...
  "desktop.cli.installed.message":
    "CLI instal·lada a {{path}}\n\nReinicieu el terminal per utilitzar l'ordre 'aidev-cli'.",
