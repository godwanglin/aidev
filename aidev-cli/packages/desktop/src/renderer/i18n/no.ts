export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AidevCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AidevCLI er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert i {{path}}\n\nStart terminalen på nytt for å bruke 'aidev-cli'-kommandoen.",
