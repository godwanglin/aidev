export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من AidevCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من AidevCLI. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
