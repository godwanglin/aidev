export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią AidevCLI versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLI versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
  ...
  "desktop.cli.installed.message":
    "CLI įdiegtas į {{path}}\n\nIš naujo paleiskite terminalą, kad galėtumėte naudoti komandą 'aidev-cli'.",
