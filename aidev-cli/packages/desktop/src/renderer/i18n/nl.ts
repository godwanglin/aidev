export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van AidevCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van AidevCLI is gedownload. Wil je deze installeren en AidevCLI opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'aidev-cli' te gebruiken.",
