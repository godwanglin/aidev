export const dict = {
  ...
  "desktop.updater.none.message": "AidevCLI'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLI'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'aidev-cli' komutunu kullanmak için terminalinizi yeniden başlatın.",
