export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo AidevCLIn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLIn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää AidevCLIn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'aidev-cli'-komentoa.",
