export const dict = {
  ...
  "desktop.updater.none.message": "AidevCLI-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLI-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'aidev-cli' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
