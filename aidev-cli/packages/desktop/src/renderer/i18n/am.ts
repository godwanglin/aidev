export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የAidevCLI ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከAidevCLI ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
