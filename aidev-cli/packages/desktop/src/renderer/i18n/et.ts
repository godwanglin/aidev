export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse AidevCLI uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLI'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „aidev-cli” kasutamiseks taaskäivitage terminal.",
