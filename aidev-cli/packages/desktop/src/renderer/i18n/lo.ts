export const dict = {
  ...
  "desktop.updater.none.message": "ທ່ານກຳລັງໃຊ້ AidevCLI ເວີຊັນຫຼ້າສຸດຢູ່ແລ້ວ",
  ...
  "desktop.updater.downloaded.prompt":
    "ເວີຊັນ {{version}} ຂອງ AidevCLI ໄດ້ຖືກດາວໂຫຼດແລ້ວ, ທ່ານຕ້ອງການຕິດຕັ້ງມັນ ແລະເປີດຄືນໃໝ່ບໍ?",
