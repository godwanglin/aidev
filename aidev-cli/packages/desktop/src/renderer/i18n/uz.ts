export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon AidevCLI ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLIning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'aidev-cli' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
