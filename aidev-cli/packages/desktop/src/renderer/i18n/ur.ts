export const dict = {
  ...
  "desktop.updater.none.message": "آپ پہلے ہی AidevCLI کا تازہ ترین ورژن استعمال کر رہے ہیں۔",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLI کا ورژن {{version}} ڈاؤن لوڈ ہو چکا ہے، کیا آپ اسے انسٹال کر کے دوبارہ لانچ کرنا چاہیں گے؟",
  ...
  "desktop.cli.installed.message":
    "CLI کو {{path}} پر انسٹال کر دیا گیا۔\n\n'aidev-cli' کمانڈ استعمال کرنے کے لیے اپنا ٹرمینل دوبارہ شروع کریں۔",
