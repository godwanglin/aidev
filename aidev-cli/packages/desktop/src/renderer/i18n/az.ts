export const dict = {
  ...
  "desktop.updater.none.message": "Artıq AidevCLI-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "AidevCLI-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'aidev-cli' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
