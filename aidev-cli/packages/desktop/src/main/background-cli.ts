...
const desktopStateNames = ["ai.aidev_cli.desktop.dev", "ai.aidev_cli.desktop.beta", "ai.aidev_cli.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "aidev-cli_cli.exe" : "aidev-cli-cli"
}
