...
const releaseId = process.env.AIDEV_CLI_RELEASE
if (!releaseId) throw new Error("AIDEV_CLI_RELEASE is required")

const version = process.env.AIDEV_CLI_VERSION
if (!version) throw new Error("AIDEV_CLI_VERSION is required")
...
const macxTarGz = "aidev-cli-desktop-mac-x64.app.tar.gz"
const macaTarGz = "aidev-cli-desktop-mac-arm64.app.tar.gz"
