...
class Database extends Context.Service<Database, DatabaseShape>()("@aidev-cli/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@aidev-cli/example/UserStore") {
