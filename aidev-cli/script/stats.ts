...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/aidev-cli/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/aidev-cli...\n")
...
console.log("Fetching npm all-time downloads for aidev-cli...\n")
const npmDownloads = await fetchNpmDownloads("aidev-cli")
