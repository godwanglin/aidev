...
# Package managers
npm i -g aidev-cli@latest        # or bun/pnpm/yarn
scoop install aidev-cli             # Windows
choco install aidev-cli             # Windows
brew install anomalyco/tap/aidev-cli # macOS and Linux (recommended, always up to date)
brew install aidev-cli              # macOS and Linux (official brew formula, updated less)
sudo pacman -S aidev-cli            # Arch Linux (Stable)
paru -S aidev-cli-bin               # Arch Linux (Latest from AUR)
mise use -g aidev-cli               # Any OS
nix run nixpkgs#aidev-cli           # or github:anomalyco/aidev-cli for latest dev branch
```
...
AidevCLI ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/aidev-cli/releases) অথবা [aidev-cli.ai/download](https://aidev-cli.ai/download) থেকে ডাউনলোড করুন।
...
1. `$AIDEV_CLI_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.aidev-cli/bin` - ডিফল্ট ফলব্যাক
...
AidevCLI এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://aidev-cli.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে AidevCLI কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://aidev-cli.ai/docs)।

### অবদান (Contributing)

আপনি যদি AidevCLI এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### AidevCLI এর উপর বিল্ডিং (Building on AidevCLI)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা AidevCLI এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "aidev-cli" ব্যবহার করেন, উদাহরণস্বরূপ "aidev-cli-dashboard" বা "aidev-cli-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি AidevCLI দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/aidev-cli) | [X.com](https://x.com/aidev-cli)
