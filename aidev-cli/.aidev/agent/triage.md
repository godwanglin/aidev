...
Desktop application and browser-based app issues, including `aidev-cli web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core aidev-cli server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

AidevCLI Zen, AidevCLI Go, and billing issues.
