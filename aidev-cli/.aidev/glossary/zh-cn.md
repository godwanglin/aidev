...
- PR #13942: https://github.com/anomalyco/aidev-cli/pull/13942

## Do Not Translate (Locale Additions)

- `AidevCLI` (preserve casing in prose; keep `aidev-cli` only when it is part of commands, package names, paths, or code)
- `AidevCLI Zen`
- `AidevCLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `aidev-cli` in prose when referring to the product name; use `AidevCLI`
