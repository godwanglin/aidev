...
Use this folder for locale-specific translation guidance that supplements `.aidev-cli/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/aidev-cli/pull/12345

## Do Not Translate (Locale Additions)

- `AidevCLI` (preserve casing)
