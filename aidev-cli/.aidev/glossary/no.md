...
- PR #10018: https://github.com/anomalyco/aidev-cli/pull/10018
- PR #12935: https://github.com/anomalyco/aidev-cli/pull/12935

## Do Not Translate (Locale Additions)

- `AidevCLI` (preserve casing in prose; keep `aidev-cli` only in commands, package names, paths, or code)
- `AidevCLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
