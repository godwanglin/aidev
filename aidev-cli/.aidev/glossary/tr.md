...
- PR #15835: https://github.com/anomalyco/aidev-cli/pull/15835

## Do Not Translate (Locale Additions)

- `AidevCLI` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `aidev-cli` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `AidevCLI` in prose, `aidev-cli` only for exact technical identifiers
...
- Avoid changing `aidev-cli` to `AidevCLI` inside commands, URLs, package names, or code literals
