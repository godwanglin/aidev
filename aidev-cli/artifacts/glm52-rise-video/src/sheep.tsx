      ...
      >
        ...
        <div>
          ...
          >
            ...
            <div style={{ color: c.white }}>aidev-cli.ai/data</div>
          </div>
        </div>
      </div>
    </AbsoluteFill>
