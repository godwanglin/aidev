...
brew install anomalyco/tap/aidev-cli # macOS og Linux (anbefalet, altid up to date)
brew install aidev-cli              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
AidevCLI findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/aidev-cli/releases) eller [aidev-cli.ai/download](https://aidev-cli.ai/download).
...
1. `$AIDEV_CLI_INSTALL_DIR` - Tilpasset installationsmappe
...
AidevCLI har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://aidev-cli.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af AidevCLI, [**se vores docs**](https://aidev-cli.ai/docs).

### Bidrag

Hvis du vil bidrage til AidevCLI, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på AidevCLI

Hvis du arbejder på et projekt der er relateret til AidevCLI og bruger "aidev-cli" som en del af navnet; f.eks. "aidev-cli-dashboard" eller "aidev-cli-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af AidevCLI-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/aidev-cli) | [X.com](https://x.com/aidev-cli)
